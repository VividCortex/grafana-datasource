...
System.register([], function(exports_1) {
    ...
    function testHost(host, filters) {
        var negativeFilters = filters.filter(function (filter) { return filter.type === 'exclude'; });
        var positiveFilters = filters.filter(function (filter) { return filter.type !== 'exclude'; });
